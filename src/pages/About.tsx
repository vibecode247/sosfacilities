      ...
      <section className="relative bg-gradient-to-br from-primary/5 via-white to-primary/10 py-20 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center">
            ...
            <h2 className="font-bold mb-8 gradient-text font-outfit md:text-5xl text-4xl">Our Vision</h2>
          ...
          <div className="text-center mb-8">
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                ...
                <div className="flex flex-col items-center gap-3 bg-white/50 p-4 rounded-lg">
                  <div className="w-3 h-3 bg-primary rounded-full flex-shrink-0"></div>
                  <p className="text-base text-gray-700">To make our customers happy and satisfied</p>
                </div>
              </div>
            </div>
          </div>
