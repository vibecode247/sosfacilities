    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center text-white">
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 animate-fade-in font-outfit">
          Your Trusted Partner for <span className="text-yellow-400 drop-shadow-lg animate-pulse">Housekeeping</span> <span className="text-yellow-400 drop-shadow-lg animate-pulse">Workforce</span> Management
        </h1>
