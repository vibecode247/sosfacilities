...
const AMCCleaningClientShowcase = () => {
  return (
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Leading corporations trust our AMC contracts for consistent, cost-effective cleaning solutions
          </p>
        </div>
...
export default AMCCleaningClientShowcase;
