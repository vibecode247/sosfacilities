...
const PostConstructionClientShowcase = () => {
  return (
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Leading contractors and developers trust our post-construction cleaning for successful project handovers
          </p>
        </div>
...
export default PostConstructionClientShowcase;
